...
import { ScrollView, StyleSheet, Switch, TouchableOpacity, Alert, Linking } from 'react-native';
...
export default function SettingsScreen() {
  ...
  const handleAbout = () => {
    Alert.alert(
      'About EasyRead',
      'EasyRead Toolkit v1.0.0\n\nA powerful tool for making reading easier and more accessible. Extract text from documents and web pages with advanced OCR and text processing capabilities.\n\nBuilt with React Native and Expo.',
      [{ text: 'OK' }]
    );
  };
  ...
  const handleHelpCenter = () => {
    Alert.alert(
      'Help Center',
      'Need help? Here are some resources:\n\n• How to scan documents\n• How to import from URLs\n• Reading preferences guide\n• Troubleshooting tips\n\nFor more help, contact support.',
      [
        { text: 'Contact Support', onPress: () => Linking.openURL('mailto:support@easyread.com') },
        { text: 'OK' }
      ]
    );
  };
  ...
  const handleClearCache = () => {
    Alert.alert(
      'Clear Cache',
      'This will clear all cached data and documents. This action cannot be undone.',
      [
        { text: 'Cancel', style: 'cancel' },
  ...
  return (
    <ThemedView style={styles.container}>
      ...
      >
        ...
        <ThemedView style={styles.section}>
          <ThemedText style={styles.sectionTitle}>Reading Preview</ThemedText>
          <ThemedView style={styles.previewBox}>
            <ThemedText style={[previewStyles, styles.previewText]}>
              EasyRead makes dense text easier to read. Adjust settings above to see changes here. This preview shows how your text will appear with the current font size, line height, and alignment settings. You can customize the appearance to make reading more comfortable and accessible.
            </ThemedText>
          </ThemedView>
        </ThemedView>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  previewText: {
    color: '#333',
    lineHeight: undefined, // Will be set by previewStyles
  },
});
